 ...
 */
jQuery.extend({	
	ImpromptuDefaults: { prefix:'jqi', buttons:{ Ok:true }, loaded:function(){}, submit:function(){return true;}, callback:function(){}, opacity:0.6, zIndex: 999, overlayspeed:'slow', promptspeed:'fast', show:'show',focus:0 },
	...
	prompt: function(m,o){
		...
		if((jQuery.browser.msie && jQuery('object, applet').length > 0) || ie6)
			msgbox += '<iframe src="" class="'+ o.prefix +'fade" id="'+ o.prefix +'fade"></iframe>';
		else msgbox +='<div class="'+ o.prefix +'fade" id="'+ o.prefix +'fade"></div>';	
		...
		var positionPrompt = function(){
			...
			jqi.css({ position: "absolute", top: "15%", left: "50%", marginLeft: ((((jqi.css("paddingLeft").split("px")[0]*1) + jqi.width())/2)*-1) });					
		};
