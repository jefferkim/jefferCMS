...
$typeArr = GetSubProType($SysConfig['customerdb'],$SysConfig['language']);
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>无刷新文件批量上传系统</title>
</head>
<body>
<style>
.fu_list {
...
a.files {
	...
	background:url(../Ajax_Upload/img/fu_btn.gif) left top no-repeat;
...
<form id="uploadForm" action="../Ajax_Upload/ProFile.php">
  <table border="0" cellspacing="1" class="fu_list">
    <thead>
      <tr>
        <td colspan="3" style="background:#FFF">语言名称：<?php
	...
	?>； 图片分类： <?HtmlSelect('type',$typeArr,$currentType)?></td>
      </tr>
      <tr>
    ...
    <tbody>
      <tr>
        ...
        <td><a href="javascript:void(0);" class="files" id="idFile"></a> <img id="idProcess" style="display:none;" src="../Ajax_Upload/img/loading.gif" /></td>
      </tr>
      <tr>
        <td colspan="3">
      ...
      <tr>
        <td colspan="3" align="center" id="idMsg"><input type="button" value="开始上传" id="idBtnupload" disabled="disabled" />
          &nbsp;&nbsp;&nbsp;
...
$("idBtnupload").onclick = function(){
	...
	$("idMsg").innerHTML = "正在添加文件到您的空间中，请稍候……<br />有可能因为网络问题，出现程序长时间无响应，请点击<a href='?'><font color='red'>取消</font></a>重新上传文件";
