...
<tr class="table_title">
  ...
  <tr>
  	<td width="12%" height="30" class="title_td" bgcolor="#F6FAFD" align="right">产品名称：</td>
	<td width="38%" height="30" bgcolor="#FFFFFF" style="padding-left:10px;"><input type="text" name="called" value="<?=$called?>" class="sys_input"></td>
    <td width="12%" height="30" class="title_td" bgcolor="#F6FAFD" align="right">产品排序：</td>
	<td width="38%" height="30" bgcolor="#FFFFFF" style="padding-left:10px;"><input type="text" name="orderby" value="<?=$orderBy?>" class="sys_input"></td>
</tr>

  <tr>
  	<td width="12%" height="30" class="title_td" bgcolor="#F6FAFD" align="right">语言名称：</td>
	<td width="38%" height="30" bgcolor="#FFFFFF" style="padding-left:10px;"><?php
	if ($editMode)
	{
	...
	?></td>
    <td width="12%" height="30" class="title_td" bgcolor="#F6FAFD" align="right">产品分类：</td>
	<td width="38%" height="30" bgcolor="#FFFFFF" style="padding-left:10px;"><?HtmlSelect('pid',$typeArr,$currentType,'style="width:173px;"')?></td>
</tr>
 ...
 <tr>
    ...
    <td width="12%" height="30" class="title_td" bgcolor="#F6FAFD" align="right">是否推荐：</td>
	<td width="38%" height="30" bgcolor="#FFFFFF" style="padding-left:10px;"><?HtmlSelect('iscommend',$showArr,$currentCommend)?></td>
</tr>
 ...
 <tr>
  	<td width="12%" height="100" class="title_td" bgcolor="#F6FAFD" align="right">产品图片：</td>
...
<tr>
  	<td width="8%" height="30" class="title_td" style="padding-top:10px;" valign="top" align="right" bgcolor="#F6FAFD">产品简介：</td>
 ...
 <tr>
  	<td width="8%" height="30" class="title_td" style="padding-top:10px;" valign="top" align="right" bgcolor="#F6FAFD">详细内容：</td>
	<td height="30" colspan="3" bgcolor="#FFFFFF" style="padding:10px;">
	<?php
	include_once(ROOTDIR."/lib/fckeditor/fckeditor.php");
 ...
 <tr class="table_title" style="overflow:hidden">
    <td colspan="4" class="td_one" >产品关键字设置</td>
     </tr>
    <tr>   
