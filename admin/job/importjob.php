...
$(function()
{
	$("#btnSave").click(function()
	{
		...
		AjaxSet("importjobsave.php",q,function(data)
		{
			alert(data['result']);
			if (data['result']=='导入成功')
			{
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="main_bj">
  ...
  <tr>
    ...
    <span style="font-weight:bold">位置：</span>招聘信息管理 — 招聘数据导接
   </div>
...
<tr class="table_title">
    <td colspan="4" class="td_one">招聘数据导接</td>
    </tr>
    <tr>
     <td colspan="4">
  ...
  <tr>
  	<td width="16%" height="30" class="title_td" bgcolor="#F6FAFD" align="right">导出招聘的语言：</td>
	<td width="34%" height="30" bgcolor="#FFFFFF" style="padding-left:10px;"><?HtmlSelect("outputLan",$lanArr,"cn")?></td>
    <td width="16%" height="30" class="title_td" bgcolor="#F6FAFD" align="right">导入招聘的语言：</td>
