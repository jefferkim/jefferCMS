...
$(function()
{
	$("#btnSave").click(function()
	{
		...
		AjaxSet("importnewssave.php",q,function(data)
		{
			alert(data['result']);
			if (data['result']=='导入成功')
			{
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="main_bj">
  ...
  <tr>
    ...
    <span style="font-weight:bold">位置：</span>新闻信息管理 — 新闻数据导接
   </div>
...
<tr class="table_title">
    <td colspan="4" class="td_one">新闻数据导接</td>
    </tr>
    <tr>
     <td colspan="4">
  ...
  <tr>
  	<td width="16%" height="30" class="title_td" bgcolor="#F6FAFD" align="right">导出新闻的语言：</td>
	<td width="34%" height="30" bgcolor="#FFFFFF" style="padding-left:10px;"><?HtmlSelect("outputLan",$lanArr,"cn")?></td>
    <td width="16%" height="30" class="title_td" bgcolor="#F6FAFD" align="right">导入新闻的语言：</td>
