...
while (!$text_fieldRs->EOF)
{
	...
	$text_fieldObj->SETVALUE = $rs->fields[$fieldObj->FIELDNAME];
...
while (!$deltext_fieldRs->EOF)
{
	...
	$deltext_fieldObj->SETVALUE = $rs->fields[$fieldObj->FIELDNAME];
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="main_bj">
  ...
  <tr>
    ...
    <span style="font-weight:bold">位置：</span>图片信息管理 — 图片分类修改
   </div>
