...
if (UserIsInRole('A3',$userRole))
{
	$link = new Linker("javascript:;","删除会员","btnDelete");
	$linkList[] = $link;
}
if (UserIsInRole('A1',$userRole))
{
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="main_bj">
  <tr>
    ...
    <span style="font-weight:bold">位置：</span>系统管理员管理 — 系统管理员列表<em id="total" style="font-weight:bold"></em>
   </div>
     ...
     <table width="100%" border="0" cellpadding="0" cellspacing="0"  class="table_title" id="tablist" >
      ...
      <thead>      
          <tr>
            ...
            <td width="18%"  align="center" class="td_title">用户名</td>
            <td width="16%"  align="center" class="td_title">公司名称</td>
            <td width="14%"  align="center" class="td_title">上次登陆时间</td>
            <td width="8%" align="center" class="td_title">是否锁定</td>
