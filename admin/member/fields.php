...
$pfRs = $SysConfig['customerdb']->Execute($sql);
?>
    ...
    <td width="100%" align="left" valign="top" class="cn">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr align="center" valign="middle">
            ...
            <td width="395" height="36" align="left" valign="middle" class="le"> 会员自定义字段管理 <input type="button" id="btnRefresh" value="刷新" class="btnstyle"></td>
