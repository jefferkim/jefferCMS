...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="main_bj">
  <tr>
    ...
    <span style="font-weight:bold">位置：</span>基础信息管理 — 内容信息管理<em id="total" style="font-weight:bold"></em>
   </div>
  ...
  <div id="box" style="overflow-y:auto; vertical-align:top; margin-top:4px;">
  <style>
