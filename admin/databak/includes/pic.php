...
class upload {
 ...
 private $waterimg = "cn/images/logo.gif"; //水印图片gif
   ...
   if ($this->watermark == 2) {
    ...
    switch ($this->watertype) {
     case 1 : //加水印字符串
      ...
      cn/imagestring($nimage, 2, 3, $iinfo[1] - 15, $this->waterstring, $black);
      break;
     case 2 : //加水印图片
      $simage1 = imagecreatefromgif($this->waterimg);
      $waterImg = getcn/imagesize($this->waterimg);
