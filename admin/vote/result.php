...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="main_bj">
  <tr>
    ...
    <span style="font-weight:bold">位置：</span>投票信息管理 — 投票答案列表<em id="total" style="font-weight:bold"></em>
   </div>
  ...
  <style>
	...
	.img_ico{ vertical-align:middle; margin-right:5px; }
     ...
     <table width="100%" border="0" cellpadding="0" cellspacing="0"  class="table_title" id="tablist" >
       ...
       <tr>
            ...
            <td width="25%"  class="td_title" style="padding-left:10px;">投票答案</td>
            <td width="25%"  class="td_title" style="padding-left:10px;">投票问题</td>
            <td width="10%"  align="center" class="td_title">语言</td>
            <td width="15%"  align="center" class="td_title">更新时间</td>
   ...
   <thead>
    <tr>
      <td colspan="7" height="30"  align="center" class="btn_line">
