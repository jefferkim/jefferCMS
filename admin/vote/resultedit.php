...
$resultRs = $SysConfig['customerdb']->Execute("SELECT * FROM t_result WHERE id=?",array($resultId));
$resultObj = $resultRs->FetchObject();

$result = $resultObj->RESULT;
$currentLan = $resultObj->LANGUAGE;
$currentType= $resultObj->VOTEID;
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="main_bj">
  ...
  <tr>
    ...
    <span style="font-weight:bold">位置：</span>投票信息管理 — 投票答案修改
   </div>
