...
<tr class="table_title">
    <td colspan="4" class="td_one">投票答案添加/修改</td>
    </tr>
  ...
  <tr>
  	<td width="10%" height="30" class="title_td" bgcolor="#F6FAFD" align="right">答案名称：</td>
	<td width="40%" height="30" bgcolor="#ffffff" style="padding-left:10px;"><input type="text" name="result" value="<?=$result?>" class="sys_input"></td>
    <td width="10%" height="30" class="title_td" bgcolor="#F6FAFD" align="right">所属问题：</td>
	<td width="40%" height="30" bgcolor="#ffffff" style="padding-left:10px;"><?HtmlSelect('vote',$voteArr,$currentType)?></td>
</tr>
 ...
 <tr>
    ...
    <td width="10%" height="30" class="title_td" bgcolor="#F6FAFD" align="right"></td>
	<td width="40%" height="30" bgcolor="#ffffff" style="padding-left:10px;"></td>
</tr>
