...
$SysConfig['domain'] = "http://testweb3.iecworld.com";
$SysConfig['rooturl'] = $SysConfig['domain']."/cn-passion/admin";		//网站根目录
...
$SysConfig['dbuser'] = 'cn-passion';
$SysConfig['dbpass'] = 'ps5566';
$SysConfig['database'] = "maindb";
...
$SysConfig['maindb']->debug = true;	//是否开启调试模式
