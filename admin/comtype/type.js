...
function dataProcess(data)
{
	...
	{
		var row = $('<tr align="center" valign="middle"><td width="22" height="25" valign="middle" rel="chkbox"></td><td width="8" height="25"></td><td width="68" height="25" rel="id"></td><td width="8" height="25"></td><td width="271" height="25" rel="called"></td><td width="8" height="25"></td><td width="10%" height="25" rel="language"></td><td width="8" height="25"></td><td width="250" height="25" rel="parent"></td><td width="8" height="25"></td><td width="50" height="25" rel="order"></td></tr>');
...
$(function()
{
	...
	$("#btnDelete").click(function()
	{
		...
		if (checkedVal != "")
		{
			if (window.confirm("确定要删除吗？删除时要确定分类下面没有任何其它信息"))
			{
				var data = "action=del";
